      ...
      child: Column(
        ...
        children: [
          ...
          if (text.isNotEmpty) ...[
            ...
            // 3-way body styling:
            //   - Quote repost (user wrote text): quote style (italic +
            //     curly quotes + lighter). Signals the body is the user's
            //     commentary on the source.
            //   - Plain repost (no quote, user wrote nothing): mini-card
            //     style (smaller, lighter, no curly quotes). The body
            //     shows the source's text in the same style as the
            //     mini-card below, so it is clearly NOT user-written.
