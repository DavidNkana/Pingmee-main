                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return SearchConnectCard(
                            ...
                            // Trigger setState on the search sheet so
                            // the button label flips to "Request sent"
                            // immediately after sendFriendRequest
                            // returns. The shared widget lives in a
                            // shared file and can't reach our private
                            // State class, so we wire the callback
                            // through.
                            onConnectSent: () {
                              if (mounted) setState(() {});
                            },
